...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field users on 'Issue'
        m2m_table_name = db.shorten_name(u'it_issue_users')
    ...
    def backwards(self, orm):
        # Removing M2M table for field users on 'Issue'
        db.delete_table(db.shorten_name(u'it_issue_users'))
