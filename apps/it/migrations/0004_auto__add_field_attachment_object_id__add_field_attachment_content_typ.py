...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'it_attachment', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Attachment.content_type'
        db.add_column(u'it_attachment', 'content_type',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'it_attachment', 'object_id')

        # Deleting field 'Attachment.content_type'
        db.delete_column(u'it_attachment', 'content_type_id')
